// Mapa mínimo hero_id → nombre. Solo héroes de presencia competitiva alta.
// Para IDs desconocidos se muestra "Héroe #ID".
export const HERO_NAMES: Record<number, string> = {
  ...
  136: 'Marci', 137: 'Primal Beast', 138: 'Muerta', 145: 'Kez',
}

export function heroName(id: number): string {
  return HERO_NAMES[id] ?? `Héroe #${id}`
}
