...
export const TI2026_TEAMS: TITeam[] = [
  ...
  { id: 'boomboys',        name: 'Boomboys',         tag: 'BB',      group: 'A', logo: '/logos/teams/boomboys.png' },
  { id: 'team-falcons',    name: 'Team Falcons',     tag: 'Falcons', group: 'A', logo: '/logos/teams/team-falcons.svg',    steamTeamId: 8894818 },
  { id: 'iron-wing',       name: 'Iron Wing',        tag: 'IW',      group: 'A', logo: '/logos/teams/iron-wing.png' },
  { id: 'nigma-galaxy',    name: 'Nigma Galaxy',     tag: 'NGX',     group: 'A', logo: '/logos/teams/nigma-galaxy.svg',    logoPlaceholder: true },
  { id: 'lgd-gaming',      name: 'LGD Gaming',       tag: 'LGD',     group: 'A', logo: '/logos/teams/lgd-gaming.png',      steamTeamId: 2108395 },
  { id: 'og-esports',      name: 'OG Esports',       tag: 'OG',      group: 'A', logo: '/logos/teams/og-esports.png',      steamTeamId: 39 },
  ...
  { id: 'aurora-gaming',   name: 'Aurora Gaming',    tag: 'Aurora',  group: 'B', logo: '/logos/teams/aurora-gaming.svg' },
  { id: 'team-spirit',     name: 'Team Spirit',      tag: 'TSpirit', group: 'B', logo: '/logos/teams/team-spirit.svg',     steamTeamId: 7119388 },
  { id: 'team-liquid',     name: 'Team Liquid',      tag: 'Liquid',  group: 'B', logo: '/logos/teams/team-liquid.svg',     steamTeamId: 2163 },
  { id: 'xtreme-gaming',   name: 'Xtreme Gaming',    tag: 'XG',      group: 'B', logo: '/logos/teams/xtreme-gaming.png',   steamTeamId: 8597391 },
  { id: 'vici-gaming',     name: 'Vici Gaming',      tag: 'VG',      group: 'B', logo: '/logos/teams/vici-gaming.png',     steamTeamId: 15 },
  { id: 'gamerlegion',     name: 'GamerLegion',      tag: 'GL',      group: 'B', logo: '/logos/teams/gamerlegion.png' },
